...
class PaperPlanBridge:
    ...
    async def _build(self, raw_context: Mapping[str, Any], *, symbol: str,
        ...
        # D63: the window is the governed YAML list on the playbook, never the
        # current regime substituted in as a one-element window.
        ...
        arb_candidate = {
            ...
            "direction": intended,
            "regime_window": tuple(playbook.regime_window),
        ...
        risk.update({
            ...
            "environment": risk.get("environment", self.environment),
        })
