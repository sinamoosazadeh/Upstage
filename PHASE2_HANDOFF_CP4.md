...
## INTERFACES
(module | class/function | signature | semantics | version) — exhaustive for everything CP-5 consumes; nothing invented, everything cited.
...
## OPEN-ISSUES
(exact [ISSUE-CP4-0NN] format from PROTOCOL P13; mirrored to DECISION_LOG §B/CP-4; or "none")
