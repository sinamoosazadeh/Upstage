...
- ENV NOTE (session pinned to `arena/01a09fcd-upstage`): everything is pushed to that branch (`46b6ab5..0b20c09` and `8470bd3`, `41deb78`, then the closeout commit); the owner merges with a **plain merge** (never squash), exactly as CP-3…CP-7.
